...
function georgesimos_setup() {
	...
	add_theme_support( 'post-thumbnails' );
        ...
        // Display your image like you want .gs
        // add_image_size( 'georgesimos-small-thumb', 300, 150, true );
...
function georgesimos_scripts() {
    if (is_page_template('page-templates/3d_header_page.php')) :
        wp_enqueue_style('georgesimos-reset-css', get_template_directory_uri() . '/custom-style/css/reset.css');
        wp_enqueue_style('georgesimos-style-css', get_template_directory_uri() . '/custom-style/css/style.css');
        wp_enqueue_script('georgesimos-function', get_template_directory_uri() . '/custom-style/js/jquery-2.1.1.js', array( 'jquery' ), '20151215', true, true );
        wp_enqueue_script('georgesimos-function', get_template_directory_uri() . '/custom-style/js/main.js', array( 'jquery' ), '20151215', true, true );
        wp_enqueue_script('georgesimos-function', get_template_directory_uri() . '/custom-style/js/modernizr.js', array(  ), '20151215', true, false );
	...
	wp_enqueue_script( 'georgesimos-function', get_template_directory_uri() . '/js/function.js', array( 'jquery' ), '20151215', true );
        wp_localize_script( 'georgesimos-function', 'screenReaderText', array(
		'expand'   => '<span class="screen-reader-text">' . __( 'expand child menu', 'georgesimos' ) . '</span>',
		'collapse' => '<span class="screen-reader-text">' . __( 'collapse child menu', 'georgesimos' ) . '</span>',
            ) );
